...
class SitterForm(forms.ModelForm):
    class Meta:
        model = Sitter
        fields = [
            's_no','s_name','s_dob','s_location','s_gender','s_nok','s_NIN','s_recomender','s_religion','s_educ_level','s_email','s_tel'
        ]
        ...
        widgets = {
            ...
            's_recomender': forms.TextInput(attrs={'class':'form-control s_recomender'}),
            's_religion' : forms.TextInput(attrs={'class':'form-control s_religion'}),
            's_educ_level': forms.TextInput(attrs={'class':'form-control s_educ_level'}),
        ...
        fieldsets = (
            ...
            ('More Details',{
                'fields': (
                's_dob','s_location','s_gender','s_nok','s_NIN','s_recomender','s_religion','s_educ_level','s_email','s_tel'
                ),
            })
        )
...
class PaymentCurrencyForm(forms.ModelForm):
    class Meta:
...
class AttendanceForm(forms.ModelForm):
    ...
    class Meta:
        model = Attendance
        fields = [
            'a_sitter', 'a_baby', 'a_payment_date'
            ]
        widgets = {
...
class InventorySupplyReceiptForm(forms.ModelForm):
    class Meta:
        model = InventorySupplyReceipt
        fields = '__all__'

class ResaleItemForm(forms.ModelForm):
    class Meta:
        model = ResaleItem
        fields = '__all__'
